...
namespace Improbable.Gdk.GameObjectCreation
{
    ...
    internal class GameObjectInitializationSystem : ComponentSystem
    {
        ...
        private readonly Dictionary<string, (IEntityRepresentation representation, ComponentType[] expectedTypes)> entityTypeExpectations
            = new Dictionary<string, (IEntityRepresentation representation, ComponentType[] expectedTypes)>();

        public GameObjectInitializationSystem(IEntityGameObjectCreator gameObjectCreator, EntityLinkerDatabase entityLinkerDatabase, GameObject workerGameObject)
        {
            ...
            if (entityLinkerDatabase == null)
            {
                throw new ArgumentException("entityLinkerDatabase can not be Null", nameof(entityLinkerDatabase));
            }
            ...
            foreach (var entityRepresentation in entityLinkerDatabase.EntityRepresentationResolvers)
            {
