...
namespace Playground
{
    public static class WorkerUtils
    {
        ...
        public static void AddClientSystems(World world, EntityLinkerDatabase entityLinkerDatabase)
        {
        ...
        public static void AddGameLogicSystems(World world, EntityLinkerDatabase entityLinkerDatabase)
        {
            AddLifecycleSystems(world);
